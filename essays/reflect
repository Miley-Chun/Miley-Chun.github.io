...
layout: essay
type: essay
title: "Lessons in Software Engineering Practices"
date: 2025-12-12
published: true
labels:
  - Coding Standards
...
<img width= "200px" class="rounded float-start pe-4" src="../img/reflect.jpeg">
...
## Coding Standards
Coding standards are the agreed-upon rules for writing and organizing code. In our class, we used ESLint in VSCode to enforce these standards, which flagged issues ranging from missing spaces to unnecessary blank lines. At first, this felt nitpicky and restrictive. Minor errors seemed insignificant, and the red squiggly lines sometimes became overwhelming.
